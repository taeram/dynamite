...
setenv_variables = ['API_KEY', 'DATABASE_URL', 'FLASK_ENV', 'SENDER_EMAIL', 'MAILGUN_SMTP_PASSWORD', 'MAILGUN_SMTP_PORT', 'MAILGUN_SMTP_SERVER', 'MAILGUN_SMTP_LOGIN', 'NOTIFY_EMAIL']
